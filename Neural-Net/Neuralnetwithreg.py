...
class NeuralNet:
    ...
    def compute_cost(self,X, y,regularization):
        ...
        # add regularization 
        data_loss += regularization/2 * (np.sum(np.square(self.W1)) + np.sum(np.square(self.W2)))
    ...
    def fit(self,X,y,num_epochs,regularization):
        """
        ...
        for i in range(0,num_epochs):
            ...
            # add regularization
            dw2 += regularization * self.W2
            dw1 += regularization * self.W1
...
NN.fit(X,y,num_epochs,regularization)
#
